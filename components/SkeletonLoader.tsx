...
const SkeletonLoader: React.FC<{ isMobile: boolean }> = ({ isMobile }) => (
    <div className="space-y-4">
        {/* Disclaimer Skeleton (same for both) */}
        ...
        {/* Conditional Text Skeleton */}
        {isMobile ? (
            <div className="space-y-3 pl-3">
                <div className="h-4 w-11/12 rounded skeleton-base" />
