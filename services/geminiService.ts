...
2.  **SOURCE PURITY & GROUNDING (CRITICAL):**
    ...
    // FIX: Add rule to explicitly state that an answer for a different tradition should not be provided if a source for the selected denomination is not found.
